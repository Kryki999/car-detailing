                  ...
                  return (
                    ...
                    >
                      <div className="rounded-xl overflow-hidden">
                        <ImageComparison
                          beforeImage={item.beforeImage ? urlFor(item.beforeImage).width(1600).url() : "/placeholder.svg"}
                          afterImage={item.afterImage ? urlFor(item.afterImage).width(1600).url() : "/placeholder.svg"}
